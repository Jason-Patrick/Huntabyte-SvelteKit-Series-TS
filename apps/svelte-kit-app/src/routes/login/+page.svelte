...
<div class="flex flex-col items-center h-full w-full">
    <h2 class="mt2 text-center text-3xl font-bold tracking-tight text-base-content">
    ...
    <form action="?/login" method="post" class="flex flex-col items-center space-y-2 w-full pt-4">
        ...
        {#if form?.notVerified}
            <div class="alert alert-error shadow-lg w-full max-w-md pt-2 text-white">
                <div>
                    <svg xmlns="http://www.w3.org/2000/svg" class="stroke-current flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                    <span>You must verify your email before you login</span>
                </div>
            </div>
        {/if}
    </form>
